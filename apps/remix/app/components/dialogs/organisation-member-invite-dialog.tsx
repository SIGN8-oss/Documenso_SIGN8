...
export const OrganisationMemberInviteDialog = ({
  ...
  const downloadTemplate = () => {
    const data = [
      { email: 'admin@sign8.eu', role: 'Admin' },
      { email: 'manager@sign8.eu', role: 'Manager' },
      { email: 'member@sign8.eu', role: 'Member' },
    ];
    ...
    downloadFile({
      filename: 'sign8-organisation-member-invites-template.csv',
      data: blob,
    });
  };
